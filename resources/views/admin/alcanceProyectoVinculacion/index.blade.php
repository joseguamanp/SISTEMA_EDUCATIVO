...
@section('content')
  <div id="content-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4">
          {!! Form::open(['url' => 'admin/alcanceproyecto', 'method' => 'POST']) !!}
        ...
        <div class="col-md-8">
          <div class="card mb-3">
            ...
            <div class="card-header">
              ...
              Tipo de alcance del proyecto de vinculación con la sociedad
            </div>
                    ...
                    @foreach($data as $datas)
                      <tr>
                        ...
                        <td>
                          ...
                          @else
                            {!!link_to_route('alcanceproyecto.edit', $title = 'Editar', $parameters = $datas->id,
                          ...
                          <td>
                            @if($datas->deleted_at!='')
                              <a class="btn btn-primary btn-block btn-sm" href="/admin/alcanceproyecto/{{$datas->id}}/restaurar">Activar</a>
                            @else
                              {!!Form::open([
                                'route' => ['alcanceproyecto.destroy',$datas->id],
                                'method'=>'DELETE']) !!}
                                <div class="form-group">
