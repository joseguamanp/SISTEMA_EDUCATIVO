...
<div id="content-wrapper">
    <div class="container-fluid">
        	<div class="row">
        		<div class="col-md-4">
        			{!! Form::open(['url' => 'admin/discapacidad', 'method' => 'POST']) !!}
				                  ...
				                  <tbody>
									...
									<tr>
										...
										<td>
                                                                                    ...
                                                                                    @else
											{!!link_to_route('discapacidad.edit', 
                                                                                            $title = 'Editar', 
                                                                                            $parameters = $datas->id, 
										...
										<td>
											@if($datas->deleted_at!='')
												<a class="btn btn-primary btn-block btn-sm" href="/admin/discapacidad/{{$datas->id}}/restaurar">Restaurar</a>
											@else
													{!! Form::open(['route' => ['discapacidad.destroy',$datas->id],'method'=>'DELETE']) !!}
											    <div class="form-group">
