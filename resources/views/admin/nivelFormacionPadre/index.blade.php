...
@section('content')
  <div id="content-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4">
          {!! Form::open(['url' => 'admin/formacionpadre', 'method' => 'POST']) !!}
        ...
        <div class="col-md-8">
          <div class="card mb-3">
            <div class="card-header">
              ...
              Nivel de formación del padre</div>
              <div class="card-body">
                      ...
                      @foreach($data as $datas)
                        <tr>
                          ...
                          <td>
                            ...
                            @else
                              {!!link_to_route('formacionpadre.edit', $title = 'Editar', $parameters = $datas->id,
                          ...
                          <td>
                              @if($datas->deleted_at!='')
                                <a class="btn btn-primary btn-block btn-sm" href="/admin/formacionpadre/{{$datas->id}}/restaurar">Activar</a>
                              @else
